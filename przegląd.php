    ...
    <div id="contener">
        <div id="lc">
                ...
                <?php
                    ...
                    $Opis=$_POST['Opis'];
                        $connect=mysqli_connect("localhost","root","","pszczelarstwo");
                        $sql="INSERT INTO `przeglad`(`Ul`,`Data`,Opis)VALUES('$Ul','$Data','$Opis')";
                        $wynik=mysqli_query($connect,$sql);	
                        mysqli_close($connect);
                    }
		        ?>    
        ...
        <table>
            <tr>    
                <th>Ul</th> <th>Data</th> <th>Opis</th> 
            </tr> 
            <?php
                $connect=mysqli_connect("localhost","root","","pszczelarstwo");
                $sql="SELECT * FROM `przeglad`";
                $wynik=mysqli_query($connect,$sql);
                    while($wiersz=mysqli_fetch_assoc($wynik))
                    {
                        echo '<tr>';
                        echo'<td>'.$wiersz['Ul'].' '.'</td><td>'.$wiersz['Data'].' '.'</td><td>'.$wiersz['Opis'].'</td><br>';
                        echo '</tr>';
                    }
                    mysqli_close($connect);
            ?>
